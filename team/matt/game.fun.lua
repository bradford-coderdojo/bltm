            ...
            for i,item in ipairs(menu.items) do
                ...
                if item.cursor==menu.cursor then
                    ...
                    if item.call then -- do this
                        if item and item.decision and item.decision.name=="yeslvl2" then
                            change_level(3)
                            menu.show()
                        elseif item and item.decision and item.decision.name=="exit" then --exit menu
                            menu.show() -- hide
                        else
                            if item and item.decision and item.decision.name=="yesapple" then
                                for _,loot in ipairs(entities_items("loot")) do
                                    loot.active=true
                                    loot.player=false
                                end
